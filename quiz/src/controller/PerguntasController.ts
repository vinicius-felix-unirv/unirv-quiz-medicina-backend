...
export class PerguntasController {
  ...
  async getAllPerguntasByQuizIdForProf(req: Request, res: Response): Promise<Response> {
    ...
    const perguntas = await perguntaService.getAllPerguntasByQuizIdAndCategoriaForProf(skip, take, quizId, categoriaId);
