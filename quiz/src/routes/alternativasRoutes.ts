...
// alternativasRoutes.get('/alternativas/all/:id', isAuthenticated, alternativasController);
// alternativasRoutes.get('/alternativas/:id', isAuthenticated, alternativasController);
// alternativasRoutes.put('/alternativas/:id', isAuthenticated, alternativasController);
